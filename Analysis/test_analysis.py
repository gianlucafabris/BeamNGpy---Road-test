...
#this code is form https://github.com/sbft-cps-tool-competition/cps-tool-competition/blob/main/code_pipeline/test_analysis.py
...
# Itertools Recipes. see: https://docs.python.org/3/library/itertools.html
